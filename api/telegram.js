...
export default async function handler(req, res) {
  ...
  try {
    ...
    if (update.inline_query) {
      ...
      let gameNames = ['blockrushsuper','ludorush','snakerush','snakegarden','cricketrush','spacerush','castlerush','ticrush','CheckersRush','snakeraidrush'];
      ...
      if (q.includes('cricket')) gameNames=['cricketrush']; if(q.includes('space'))gameNames=['spacerush']; if(q.includes('castle'))gameNames=['castlerush']; if(q.includes('tic'))gameNames=['ticrush']; if(q.includes('checker'))gameNames=['CheckersRush'];
